<%@ Page Language="C#" Title="Edit Student" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_Edit_Student.aspx.cs" Inherits="TES.Admin.Admin_Edit_Student" %>
                        ...
                        <div class="form-group">
                            <div class="col-md-4" style="padding: 0px;">
                                <asp:DropDownList ID="ddlReg" runat="server" CssClass=" form-control">
                                    ...
                                    <asp:ListItem Value="FA" Text="FA"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-4" style="padding: 0px;">
