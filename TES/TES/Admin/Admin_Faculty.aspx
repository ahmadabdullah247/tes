...
<asp:Content ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <asp:GridView ID="gvStudent" runat="server" AutoGenerateColumns="False" DataKeyNames="SupervisorId" PageSize="7" AllowPaging="True" CssClass="table table-bordered" OnPageIndexChanging="gvStudent_PageIndexChanging">
                        <Columns>
